...
function Hero() {
  return (
    <section
      id="hero"
      className=" bg-gradient-top pt-[80px] xl:pt-[60px] 2xl:pt-[180px] "
    >
      {
        // desktop
        <div className="mx-auto hidden max-w-7xl flex-col items-center justify-start border-none align-middle xl:flex xl:flex-row xl:flex-wrap xl:justify-between xl:px-8">
          <div className="space-y-2.5 pb-3 text-center text-[13px] font-bold uppercase tracking-wider md:text-[15px] xl:max-w-[46%] xl:space-y-5 xl:text-left">
            ...
            <div className="xl:flex xl:items-center xl:gap-x-3 xl:text-base">
              <p>I am a</p>
              <span
            ...
            <div>
              <p className="px-2 text-center font-normal normal-case tracking-normal xl:px-0 xl:text-left">
                Based in Nairobi, Kenya. I specialize in creating robust and
                efficient web applications tailored to meet clients' needs. I'd
                love to discuss your project with you.
              </p>
              <div className="my-2 flex w-max flex-col gap-x-3">
...

      {
        ...
        <div className=" mx-auto flex max-w-7xl flex-col items-center justify-start border-none align-middle xl:hidden xl:flex-row xl:flex-wrap xl:justify-between xl:px-8">
          ...
          <p className="px-2 text-center">
            Based in Nairobi, Kenya. I specialize in creating robust and
            efficient web applications tailored to meet clients' needs. I'd love
