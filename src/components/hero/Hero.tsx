    ...
    // desktop
     <div className="hidden xl:flex mx-auto min-h-screen flex-col items-center justify-start border-none align-middle xl:flex-row xl:flex-wrap xl:justify-between xl:px-8 max-w-7xl">
            ...
            <div className="flex flex-col w-max my-2 gap-x-3">
              <div className="flex h-max w-full items-center justify-center gap-3 py-6 xl:items-start xl:justify-start ">
                <Link
                  ...
                  title="Github"
                >
                  <Image alt="github" src={github} height={35} width={35} />
                </Link>
                <Link
                  ...
                  title="LinkedIn"
                >
                  <Image alt="linkedin" src={linkedIn} height={35} width={35} />
                </Link>
                <Link
                  target="_blank"
                  ...
                  title="twitter"
                >
                  <Image alt="twitter" src={twitter} height={35} width={35} />
                </Link>
              </div>
        ...
        <div className=" relative flex  h-[23rem] w-[23rem] flex-col items-center justify-center uppercase md:h-[34rem] md:w-[34rem] lg:h-[25rem] lg:w-[25rem] xl:h-[40rem] xl:w-[40rem]">
          ...
          <span className=" absolute bottom-28 left-8 z-20 flex items-center justify-center space-x-2 rounded-3xl border-2 border-card-foreground bg-background px-4 py-1 font-bold shadow-pill md:bottom-40 md:left-6 md:space-x-4 md:rounded-[65px] md:px-4  md:py-2 lg:bottom-32 lg:left-0 lg:space-x-3 lg:py-1 xl:space-x-6 xl:bottom-44 ">
          ...
          <span className=" absolute bottom-20 right-8 z-20 flex items-center justify-center space-x-2 rounded-3xl border-2 border-card-foreground bg-background px-4 py-1 font-bold shadow-pill md:bottom-32 md:space-x-4 md:rounded-[65px] md:px-4 md:py-2 lg:bottom-20 lg:right-2 lg:space-x-3 lg:py-1 xl:space-x-6 xl:bottom-36 xl:right-6">
            <span className="w-1/2 space-x-2 text-xl leading-5 md:text-4xl  lg:text-2xl xl:text-4xl">
              <span>11</span>
            </span>
